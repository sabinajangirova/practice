...
<?php
    \yii\bootstrap\Modal::begin([
        ...
        'id'=>'cart',
        'size'=>'modal-lg',
        'footer'=>'<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Continue shopping</button>
        <a href="'. \yii\helpers\Url::to(['cart/view']).'" class="btn btn-success">Send order</a>
