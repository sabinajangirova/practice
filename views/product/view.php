                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <?= Html::img($mainImg->getUrl(), ['alt'=>$product->img])?>
                            <h3>ZOOM</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php if ($product->new):?>
                                <?= \yii\helpers\Html::img("@web/images/home/new.png", ['alt'=>'New product', 'class'=>'newarrival'])?>
                            <?php endif; ?>

                            <?php if ($product->sale):?>
                                <?= \yii\helpers\Html::img("@web/images/home/sale.png", ['alt'=>'On sale', 'class'=>'newarrival'])?>
                            <?php endif;?>
                            <h2><?= $product->name ?></h2>
                            ...
                            <div class="item <?php if($i==0) echo 'active'?>">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <?= Html::img("@web/images/products/{$hit->img}", ['alt'=>$hit->img])?>
                                                <h2>$<?= $hit->price?></h2>
